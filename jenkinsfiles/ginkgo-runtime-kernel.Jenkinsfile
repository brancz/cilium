...
pipeline {
    ...
    environment {
        ...
        BASE_IMAGE="""${sh(
                returnStdout: true,
                script: 'if [ "${run_with_race_detection}" = "" ]; then echo -n "scratch"; else echo -n "quay.io/cilium/cilium-runtime:32fbef6be2f4e1ac7c501623ead3779dff9144fb@sha256:5de9e131e81898ed83d6473aff3ef3ec3170b88f527e410611c715f06fe7a3bc"; fi'
            )}"""
    }
